...
地形(ちけい)(ちけい)とコードから正(ただ)しい処理(しょり)(しょり)のコードを選択(せんたく)してみよう！<br>

選(えら)べるチャンスはは1回(かい)だけなので、注意(ちゅうい)してみよう！
...
player.onChat("3", function () {
    ...
    player.say("鉱床(こうしょう)(こうしょう)発見(はっけん)！")
})
```
